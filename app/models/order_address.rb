class OrderAddress
  ...
  with_options presence: true do
    ...
    validates :dep_place_id, numericality: { other_than: 0, message: "can't be blank" }
  ...
  def save
    ...
    Address.create(post_no: post_no, dep_place_id: dep_place_id, city: city, city_no: city_no, building: building, phone_no: phone_no, order_id: order.id)
  end
end